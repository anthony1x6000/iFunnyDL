...
Just share a post through the iFunny app to the iFunnyDL app and then it'll download the content to ``/Pictures/iFunnyDL`` or ``/Pictures/iFunny``.
## Features
...
<table>
  ...
  <tr>
    <td><a href="https://drive.filen.io/d/8a3e5164-52a9-4cde-aa6f-8a604aca492c#HreTa5Dz3fxzAuq2A9xRIPSLRMJmQbP2"><img width=350 src="https://i.imgur.com/72w0sI0.png" /></a></td>
  ...
  <tr>
    <th id="batusage">Battery Usage (&ge;Android 12)</th>
    <th id="batusage">Battery Usage (&lt;Android 12)</th>
  </tr>
  <tr>
    <td><a href="https://drive.filen.io/d/69acd9bc-ca5e-49d0-acdc-895e1a2644f6#tcm3bEP6q8YAFJBUuCi6jlmkpxMY4Ehe"><img width=350 src="https://i.imgur.com/QxmFQfe.png" /></a><br>Optimized may work, but shows problems when sharing links to app.</td>
